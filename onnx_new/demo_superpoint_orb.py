...
训练后的命令测试：
python3 demo_superpoint_orb.py --log_name="103_25_best_小广场高光" --input1="/data1/Parker/BASE/TRAIN/shujuji0310/小广场/recordgcgaoguang500/imsee_data.bag.imgs.L/" --input2="/data1/Parker/BASE/TRAIN/shujuji0310/小广场/recordgcgaoguang500/imsee_data.bag.imgs.R/" --W=640 --H=400 --cuda --display_scale=1 --weights_path="/media/xin/data1/train_data/superpoint_train_model/superpoint_R1.0.8/77_super_weight.pth" --write --write_dir=img_out/R103_104_test/103_25_best_小广场高光/
